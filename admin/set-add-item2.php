	...
	$('#crop').click(function(){
		...
		canvas.toBlob(function(blob){
			...
			reader.onloadend = function(){
				...
				$datagg = $_POST['datagg'];
                $safe_input = json_encode($datagg, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP);

				$.ajax({
					url:'upload.php',
					method:'POST',
					//$datagg : $_POST['datagg'],
                    //$safe_input : json_encode($datagg),
					data:{image:base64data,data2:"<?php echo $safe_input; ?>"},
